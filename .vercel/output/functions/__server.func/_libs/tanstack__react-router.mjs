...
function ClientOnly({ children, fallback = null }) {
  return useHydrated() ? /* @__PURE__ */ jsxRuntimeExports.jsx(ee.Fragment, { children }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ee.Fragment, { children: fallback });
}
function useHydrated() {
  return ee.useSyncExternalStore(subscribe, () => true, () => false);
}
function subscribe() {
  return () => {
  };
